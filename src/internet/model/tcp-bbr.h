...
protected:
   ...
   * \param rs rate sample
   */
  void HandleProbeRTT (Ptr<TcpSocketState> tcb, const TcpRateOps::TcpRateSample &rs);
   ...
   * \param rs rate sample
   */
  void UpdateBtlBw (Ptr<TcpSocketState> tcb, const TcpRateOps::TcpRateConnection &rc,
                    const TcpRateOps::TcpRateSample &rs);
   ...
   * \param rs rate sample
   */
  void UpdateControlParameters (Ptr<TcpSocketState> tcb, const TcpRateOps::TcpRateConnection &rc,
                                const TcpRateOps::TcpRateSample &rs);
  /**
   ...
   * \param rs rate sample
   */
  void UpdateModelAndState (Ptr<TcpSocketState> tcb, const TcpRateOps::TcpRateConnection &rc,
                            const TcpRateOps::TcpRateSample &rs);
   ...
   * \param rs rate sample
   */
  void UpdateRound (Ptr<TcpSocketState> tcb, const TcpRateOps::TcpRateConnection &rc,
                    const TcpRateOps::TcpRateSample &rs);
  ...
  /**
   * \brief Max of two unsigned32 integers
   * \return uint32_t max
   */ 
  uint32_t uintMax (uint32_t t1, uint32_t t2);

  /**
   * \brief Min of two unsigned32 integers
   * \return uint32_t min
   */
  uint32_t uintMin (uint32_t t1, uint32_t t2);
